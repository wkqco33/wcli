...
func SetDefault(key string, value any) {
	globalStore.SetDefault(key, value)
}
...
func AutoDiscoverConfig(appName string, extraPaths ...string) error {
	return globalStore.AutoDiscoverConfig(appName, extraPaths...)
}
...
func WatchConfig(interval time.Duration, callback OnConfigChange) error {
	...
	globalStore.state.mu.RLock()
	configPath := globalStore.state.configPath
	globalStore.state.mu.RUnlock()
